...
#include "glyphs.h"
unsigned int const C_icon_incognito_colors[] = {
  0x00000000,
  0x00ffffff,
};

unsigned char const C_icon_incognito_bitmap[] = {
...
#ifdef OS_IO_SEPROXYHAL
#include "os_io_seproxyhal.h"
const bagl_icon_details_t C_icon_incognito = { GLYPH_icon_incognito_WIDTH, GLYPH_icon_incognito_HEIGHT, 1, C_icon_incognito_colors, C_icon_incognito_bitmap };
#endif // OS_IO_SEPROXYHAL
#include "glyphs.h"
