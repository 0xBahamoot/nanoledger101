...
extern unsigned char const C_icon_validate_14_bitmap[];
        ...
        #endif // OS_IO_SEPROXYHAL
#ifndef GLYPH_icon_incognito_BPP
        #define GLYPH_icon_incognito_WIDTH 14
        #define GLYPH_icon_incognito_HEIGHT 14
        #define GLYPH_icon_incognito_BPP 1
extern unsigned int const C_icon_incognito_colors[];
extern unsigned char const C_icon_incognito_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_icon_incognito;
        #endif // GLYPH_icon_incognito_BPP
        #endif // OS_IO_SEPROXYHAL
