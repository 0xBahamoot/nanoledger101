...
volatile uint8_t setting_1;
volatile uint8_t setting_2;
volatile uint8_t setting_3;
volatile uint8_t setting_4;

void display_settings(void);
void switch_setting_1_data(void);
void switch_setting_2_data(void);
void switch_setting_3_data(void);
...
void settings_submenu_selector(unsigned int idx)
{
  ...
  case 0:
    ...
    break;
  case 1:
    ux_menulist_init_select(0, setting_2_data_getter, setting_2_data_selector, N_storage.setting_2);
    break;
  case 2:
    ux_menulist_init_select(0, setting_3_data_getter, setting_3_data_selector, N_storage.setting_3);
  case 3:
    ux_menulist_init_select(0, setting_4_data_getter, setting_4_data_selector, N_storage.setting_4);
    break;
  default:
    ui_idle();
  }
